...
<div class="span3"> <br />
    ...
    <div class="span9"> <img class="article-pic border" style="float:right;" src="/img/blocks/image/<?php echo $article['Block']['image']?>"  />
        ...
        <div>
            ...
            <p> <span class="prefix">China : </span><a href="/articles/excellent-food-adventures/china-5000-years-of-dynastic-dining" class="gb-heading article">China - 5000 Years of Dynastic Dining</a> 
        </div>
