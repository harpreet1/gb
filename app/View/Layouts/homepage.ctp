        ...
        <div class="navbar">
			...
			<div class="nav-collapse"> 
				...
				<!--<div class="basket"><img src="/img/global/basket.png" width="76" height="76" alt="gourmet basket"></div>-->
                    ...
                    <!-- Portfolio -->
                    <li class="mzr-drop"> <a href="/categories">Food Categories</a>
                    ...
                    <li class="mzr-drop"> <a href="/users/vendors" class="js-activated">Vendor Shoppes<b class="caret"></b></a>
                            <div class="mzr-content drop-three-columns">
                            <div class="wide">
                    ...
                    <li class="mzr-drop"> <a href="/ustraditions" class="js-activated">US Food Traditions<b class="caret"></b></a>
                            <div class="mzr-content drop-three-columns">
                            <div class="wide">
                                    <?php //endforeach; ?>
                    ...
                    <li class="mzr-drop"> <a href="/traditions" class="js-activated">Int'l Food Traditions<b class="caret"></b></a>
                            <div> <a href="http://www.<?php echo Configure::read('Settings.DOMAIN'); ?>/international/africa">Africa </a><br />
                ...
                <?php echo $this->Form->create('Product', array('type' => 'GET', 'class' => 'navbar-form pull-right', 'url' => array('controller' => 'products', 'action' => 'search'))); ?> <?php echo $this->Form->input('search', array('label' => false, 'div' => false, 'autocomplete' => 'off')); ?> <?php echo $this->Form->button('<i class="icon-search icon-white"></i> Search', array('div' => false, 'class' => 'btn btn-gb', 'escape' => false)); ?> <?php echo $this->Form->end(); ?> </div>
            </div>
        <div id="account">
