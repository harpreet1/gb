...
<body>
    <div id="infinite-background">
        ...
        <div id="gb-title"> <img src="img/global/gb-title.png" width="1200" height="160" alt="gourmet-basket" /> 
         ...
         <p class="gb-heading">April - May 2013</p>
