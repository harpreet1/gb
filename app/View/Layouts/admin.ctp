	...
	<div class="navbar-inner">
		...
		<div class="nav-collapse">
			<ul class="nav">
				...
				<li><?php echo $this->Html->link('Recipes', array('controller' => 'notes', 'action' => 'index', 'admin' => true)); ?></li>
				<li><?php echo $this->Html->link('Blogs', array('controller' => 'notes', 'action' => 'index', 'admin' => true)); ?></li>
