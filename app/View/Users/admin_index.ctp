...
<table class="table-striped table-bordered table-condensed table-hover">
	<tr>
		...
		<th><?php echo $this->Paginator->sort('more'); ?></th>
	...
	<tr>
		...
		<td><a href="/admin/users/switch/show/<?php echo $user['User']['id']; ?>" class="status"><img src="/img/icon_<?php echo $user['User']['show']; ?>.png" alt="" /></a></td>
		<td><a href="/admin/users/switch/more/<?php echo $user['User']['id']; ?>" class="status"><img src="/img/icon_<?php echo $user['User']['more']; ?>.png" alt="" /></a></td>
