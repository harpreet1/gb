...
<a href="/admin/images/crop?src_dir=products/image/&src_file=<?php echo $product['Product']['image']; ?>&dst_dir=products/image/&dst_file=<?php echo $product['Product']['image']; ?>&width=600&height=600&return=/admin/" class="btn">crop 600 x 600 image</a>
